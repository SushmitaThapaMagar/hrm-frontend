  ...
  return (
    <div>
      <main className="p-6 bg-gray-50 min-h-screen flex flex-col items-center">
        {/* NextAuth User Info */}
        {session && (
          <div className="mt-6 text-gray-700 dark:text-black">
            <p>
              Study Contents as{" "}
              <i className="text-blue-700"> {session.user?.name}</i>
            </p>
          </div>
        )}
              ...
              <tbody className="text-black">
                ...
                <tr className="bg-gray-50">
                  ...
                  <td className="py-3 px-5 border-b">
                    ...
                    Display it in Dashboard for 3s, Use of Context
                    Provider:normal example of changing theme using context
                  </td>
                </tr>
                <tr>
